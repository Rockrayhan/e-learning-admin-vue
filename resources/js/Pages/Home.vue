                ...
                <section class="pt-6 bg-600" id="home">
                    <div class="container">
                        <div class="row align-items-center">
                            <div
                                class="col-md-5 col-lg-6 order-0 order-md-1 text-end"
                            >
                                <img
                            ...
                            <div
                                class="col-md-7 col-lg-6 text-md-start text-center py-6"
                            >
                            ...
                            <div class="card card-span bg-secondary">
                                <div class="card-body">
                                    <div class="row flex-center gx-0">
                                        <div
                                            class="col-lg-4 col-xl-2 text-center text-xl-start"
                                        >
                                            <img
                                        ...
                                        <div class="col-lg-8 col-xl-4">
                                            <h1
                                                class="text-light fs-lg-4 fs-xl-5"
                                            >
                                                Upcoming Our
                                                <span class="text-primary"
                                                    >Basic in Python </span
                                                >Course!
                                            </h1>
                                        </div>
                                        <div class="col-lg-12 col-xl-6">
                                            <h1
                                                class="display-1 text-light text-center text-xl-end"
                                            >
                                                11 : 02 : 45 : 21
                                            </h1>
                                        </div>
                ...
                <section>
                    <div class="container">
                        <div class="row">
                            ...
                            <div v-for="item in products" class="col-md-4 mb-4">
                                <Link
                                    class="nav-link"
                                    :href="
                                        route('productDetails', { id: item.id })
                                    "
                                >
                                    <div class="card h-100 course-card">
                                        <img
                                            class="w-100 course-img"
                                            v-bind:src="'images/' + item.image"
                                            alt="courses"
                                        />
                                        <div class="card-body">
                                            <h5
                                                class="font-sans-serif fw-bold fs-md-0 fs-lg-1"
                                            >
                                                {{ item.name }}
                                            </h5>
                                            <p class="text-danger">
                                              ...
                                              <span class="text-warning"> category: {{CategoryName(item.category_id)}} </span>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-md-12 col-lg-6 h-100">
                                ...
                                <p>
                                    ...
                                    instructors and universities. Courses
                                    include recorded auto-graded and
                                    peer-reviewed assignments, video lectures,
                                    and community discussion forums. When you
                                    complete a course, you’ll be eligible to
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="card card-span bg-600">
                                        <div class="card-body">
                                            <div class="row flex-center gx-0">
                                                <div
                                                    class="col-lg-4 col-xl-3 text-center text-xl-start"
                                                >
                                                    <img
                ...
                <section>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3 text-center mb-5">
                                <img
                                    src="assets/img/gallery/awards.png"
                                    height="100"
                                    alt="..."
                                />
                                <h1 class="my-2">32</h1>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-lg-4 mb-5">
                                <img
                                    src="assets/img/gallery/cta.png"
                                    width="280"
                                    alt="cta"
                                />
                            </div>
                            <div class="col-md-6 col-lg-5">
                                <h5
                                    class="text-primary font-sans-serif fw-bold"
                                >
                                    Subscrible now
                                </h5>
                                <h1 class="mb-5">
                                    ...
                                    <div class="col">
                                        <div class="input-group-icon">
                                            <input
                                                ...
                                                aria-label="email"
                                            /><i
                                                class="fas fa-envelope input-box-icon"
                                            ></i>
                                        </div>
                                    </div>
                                    <div class="col-auto">
...
.course-card:hover {
    ...
    box-shadow: 5px 10px 10px 10px rgba(128, 128, 128, 0.425);
}
